...
class SeedBankCropCategoriesUpdateChain {
  snapshot: any;
  afterData: any;
  beforeData: any;
  docRef: any;
  ...
  async updateConfiguration() {
    await new FirestoreService()
        .updateConfigurations("seed_bank_crop_categories", "update",
  ...
  async updateActivities() {
    ...
    await new FirestoreService()
        .updateActivities(
            "seed_bank_crop_categories", "update",
            "updated a seed bank crop category",
...
export default SeedBankCropCategoriesUpdateChain;
