 ...
 * @class
 */
class UsersKinCreateChain extends NotificationInterface {
    ...
    async notify() {
      ...
      const genericTitle = "User Kin Create Action!!";
      const genericMessage =
      `${fullname} added next of kin details  to ${item} account`;
...
export default UsersKinCreateChain;
