 ...
 * @class
 */
class UsersKinUpdateChain extends NotificationInterface {
    snapshot: any;
    afterData: any;
    beforeData: any;
    docRef: any;
    ...
    async notify() {
      ...
      const genericTitle = "Users Kin Update Action!!";
      const genericMessage =`${fullname} updated ${item} next of kin details`;
...
export default UsersKinUpdateChain;
