...
class UsersKinDeleteChain extends NotificationInterface {
    ...
    async notify() {
      ...
      const genericTitle = "User Kin Delete Action!!";
      const genericMessage =
      `${fullname} removed next of kin details  from ${item} account`;
...
export default UsersKinDeleteChain;
