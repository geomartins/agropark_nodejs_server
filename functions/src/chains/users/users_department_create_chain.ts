...
class UsersDepartmentCreateChain extends NotificationInterface {
    ...
    async notify() {
      ...
      const genericTitle = "User Department Create Action!!";
      const genericMessage =
      `${fullname} added department  to ${item} account`;
...
export default UsersDepartmentCreateChain;
