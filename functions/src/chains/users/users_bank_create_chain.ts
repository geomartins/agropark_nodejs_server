...
class UsersBankCreateChain extends NotificationInterface {
    ...
    async notify() {
      ...
      const genericTitle = "User Bank Create Action!!";
      const genericMessage =
      `${fullname} added bank details  to ${item} account`;
...
export default UsersBankCreateChain;
