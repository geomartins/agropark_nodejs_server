...
class UsersDepartmentUpdateChain extends NotificationInterface {
    ...
    async notify() {
      ...
      const genericTitle = "Users Department Update Action!!";
      const genericMessage =`${fullname} updated ${item} department details`;
...
export default UsersDepartmentUpdateChain;
