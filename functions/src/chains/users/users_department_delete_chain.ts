 ...
 * @class
 */
class UsersDepartmentDeleteChain extends NotificationInterface {
    ...
    async notify() {
      ...
      const genericTitle = "User Department Delete Action!!";
      const genericMessage =
      `${fullname} removed department details  from ${item} account`;
...
export default UsersDepartmentDeleteChain;
