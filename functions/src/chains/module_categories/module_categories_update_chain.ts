...
class ModuleCategoriesUpdateChain {
    snapshot: any;
    afterData: any;
    docRef: any;
    user_type: any;
    ...
    async updateConfiguration() {
      ...
      await new FirestoreService()
          .updateConfigurations("module_categories", confType,
    ...
    async updateModuleActivities() {
      ...
      await new FirestoreService()
          .updateModuleActivities(
              "module_categories", this.event, this.event+"d a module category",
    ...
    async updateAngolia() {
    /** Updating Algolia */
      (await new AlgoliaService("module_categories", this.snapshot)).update();
      return this;
    }
}

export default ModuleCategoriesUpdateChain;
